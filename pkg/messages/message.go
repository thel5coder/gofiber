...
var (
	...
	InvalidPositionType     = "invalid position type"
	SameRelationExist       = "same relation exist"
	TermIsActiveExist       = "term active is already exist"
	HeaderNotPresent        = "header not present"
