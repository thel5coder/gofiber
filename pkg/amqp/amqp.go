...
const (
	MailExchange = "meda.mail.exchange"
	//mail incoming
	MailIncoming = "meda.mail.incoming.queue"
	//mail deadletter
	MailDeadLetter = "meda.mail.deadletter.queue"

	//sms exchange
	SMSExchange = "meda.sms.exchange"
	//sms incoming
	SMSIncoming = "meda.sms.incoming.queue"
	//sms dead letter
	SMSDeadLetter = "meda.sms.deadletter.queue"

	// SendNotificationExchange ...
	SendNotificationExchange = "meda.send_notification.exchange"
	// SendNotification ...
	SendNotification = "meda.send_notification.incoming.queue"
	// SendNotificationDeadLetter ...
	SendNotificationDeadLetter = "meda.send_notification.deadletter.queue"
)
